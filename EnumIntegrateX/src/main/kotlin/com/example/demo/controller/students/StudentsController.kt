...
class StudentsController: Controller() {
    val studentsList = mutableListOf(
        Student(1,"MR","Dylan van der Merwe","1800123@openwindow.co.za", "student-1.png", "9801015800081", 50, "Diploma", "CC, ID, MD", 22000),
        Student(2,"MR","Trent Clinton Wright", "1800123@openwindow.co.za","student-2.png", "9806015800080", 50, "Diploma", "CC, ID, MD", 23000),
        Student(3,"MRS","Katey Cairns", "1800123@openwindow.co.za","student-3.png", "9806014800081", 50, "Degree", "CC, ID, MD", 45000),
        Student(4,"MR","Jerome Fairy Meyers", "1900123@openwindow.co.za","student-4.png", "9906205800088", 50, "Diploma", "CC, ID, MD", 22000),
